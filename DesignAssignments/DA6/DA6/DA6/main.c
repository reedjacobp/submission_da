...
int main()
{
	...
	while(1)
	{
		...
		dtostrf( Xa, 3, 2, float_ );					/* Takes the first parameter and formats it to be 3 characters, 2 decimal points of precision and puts it in float_ */
